// Fetches next earnings date for tickers in the 2026-05-11 basket refined shortlists.
// Mirrors scripts/_fetch_earnings_dates.mjs but with the holding window pinned
// to 2026-05-11 .. 2026-05-15.
...
const BASKET_DATE = process.argv[2] ?? '2026-05-11';
const HOLD_START = BASKET_DATE;
const HOLD_END = process.argv[3] ?? '2026-05-15';
