...
// Allow CLI overrides:  node script.mjs [basket_date] [expiry_iso]
const argBasket = process.argv[2];
const argExpiry = process.argv[3];
const BASKET_DATE = argBasket || monday.toISOString().slice(0, 10);
const EXPIRY_ISO = argExpiry || expiry.toISOString().slice(0, 10);
...
const c = { processed: 0, errors: 0, skipped: true };
