// Fetches next earnings date for a set of tickers (basket + refined shortlists)
// using yahoo-finance2's quoteSummary(calendarEvents) endpoint.
// Writes baskets/<basket_date>/data/earnings_dates.json.
...
const tickers = new Set([
  // Current basket names
  'ENPH', 'NN', 'GLXY', 'RIVN', 'SOFI', 'ZETA', 'RIOT', 'SMR',
  // Refined-list candidates (top of each side)
...
async function fetchOne(ticker) {
  try {
    // quoteSummary with calendarEvents gives earnings dates; quote gives earningsTimestamp
...
// Print holding-period flags
const HOLD_START = '2026-04-27';
const HOLD_END = '2026-05-01';
